...
export default function AdminLayout({ children, title, breadcrumbs }: Props) {
  ...
  const NAV_ITEMS: PortalNavItem[] = [
    ...
    { to: "/admin/applications", label: "Applications", fr: "Candidatures", icon: ClipboardList, badgeCount: pendingApps },
    ...
    { to: "/admin/enrollments",   label: "Enrollments",  fr: "Inscriptions",     icon: FileEdit },
